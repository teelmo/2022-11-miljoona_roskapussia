...
function App() {
  ...
  var createChart = function createChart(data) {
    ...
    var svg = src_select('.container').append('svg').attr('height', height + margin.top + margin.bottom).attr('width', width + margin.left + margin.right).append('g').attr('transform', "translate(".concat(width / 2, " ,").concat(height / 2 + 80, ")"));
    ...
    .attr('cx', function (d) {
      ...
      src_select('.tooltip').style('left', "".concat(event.pageX + 10, "px")).style('top', "".concat(event.pageY + 10, "px")).style('opacity', 1).html(d.name);
    ...
    .force('collide', forceCollide).force('cluster', forceCluster).force('gravity', manyBody(20)).force('x', src_x().x(function (d) {
      ...
      return height / 2 * ((min_y - d.y1) / (max_y - min_y)) + height / 8;
