...
/* harmony default export */ const GetMapData = ((/* unused pure expression or super */ null && (getData)));
...
function Map_Map() {
  ...
  var showTooltip = function showTooltip(event, d) {
    src_select(appRef.current).select('.map_tooltip').style('left', "".concat(event.offsetX + 10, "px")).style('top', "".concat(event.offsetY + 10, "px")).style('display', 'inline').style('opacity', 1).html(d.properties.Name);
  };
  var hideTooltip = function hideTooltip() {
    src_select(appRef.current).select('.map_tooltip').style('opacity', 0).style('display', 'none');
  };
  var drawMap = (0,react.useCallback)(function (data) {
    ...
    var map_data = feature(data, data.objects.features);
    // https://observablehq.com/@d3/robinson
    var projection = larrivee().fitExtent([[0, 0], [appRef.current.offsetWidth, 650]], map_data);
    var path = src_path().projection(projection);
    svg.append('g').attr('class', 'countries').selectAll('path').data(map_data.features).enter().append('path').attr('d', path).attr('id', function (d, i) {
      return i;
    }).attr('class', 'path')
  ...
  }, /*#__PURE__*/react.createElement("h3", null, currentArea), /*#__PURE__*/react.createElement("div", {
...
var GetData_getData = function getData() {
...
/* harmony default export */ const GetData = ((/* unused pure expression or super */ null && (GetData_getData)));
...
function App() {
  ...
  (0,react.useEffect)(function () {
    GetData_getData().then(function (data) {
      setMunicipalities(data.map(function (el) {
        return el.name;
      }));
    });
  }, []);
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "content_container"
  }, /*#__PURE__*/react.createElement("h3", null, "Kaikki ker\xE4tyt roskat Suomessa"), /*#__PURE__*/react.createElement("h4", null, /*#__PURE__*/react.createElement(lib/* default */.ZP, {
    once: true
  }, function (isVisible) {
    return /*#__PURE__*/react.createElement("div", {
    ...
    }, isVisible ? /*#__PURE__*/react.createElement(build/* default */.ZP, {
      easingFn: EasingFn,
      start: 0,
      delay: 0.7,
      end: 55,
    ...
    className: "content_container"
  }, /*#__PURE__*/react.createElement("h3", null, "Ilmoita roskasi"), /*#__PURE__*/react.createElement("div", {
  ...
  }, error), currentArea && /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("div", {
    className: "logo"
  }, /*#__PURE__*/react.createElement("img", {
    src: "".concat(window.location.href.includes('yle.fi') ? 'https://lusi-dataviz.ylestatic.fi/2022-11-miljoona_roskapussia/' : './', "assets/img/2022-11-miljoona_roskapussia_logo.gif"),
    alt: "Logo"
  })), /*#__PURE__*/react.createElement("h3", null, currentArea)))), /*#__PURE__*/react.createElement("div", {
    className: "content_container"
  }, /*#__PURE__*/react.createElement(components_Map, null)), /*#__PURE__*/react.createElement("noscript", null, "Your browser does not support JavaScript!"));
}
